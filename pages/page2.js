        ...
        <View style={styles.container}>
            ...
            <Animatable.View animation="fadeInUp" style={styles.containerForm}>
                <View style={styles.squaresContainer}>
                    {[
                        { id: '1', image: require('../assets/image/image8.png'), price: 24.99, name: 'Produto 1' },
                        { id: '2', image: require('../assets/image/image9.png'), price: 14.98, name: 'Produto 2' },
                        { id: '3', image: require('../assets/image/image10.png'), price: 13.99, name: 'Produto 3' },
