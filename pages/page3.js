        ...
        <View style={styles.container}>
            ...
            <Animatable.View animation="fadeInUp" style={styles.containerForm}>
                <View style={styles.squaresContainer}>
                    {[
                        { id: '1', image: require('../assets/image/image14.png'), price: 7.99, name: 'Produto 1' },
                        { id: '2', image: require('../assets/image/image15.png'), price: 5.98, name: 'Produto 2' },
                        { id: '3', image: require('../assets/image/image16.png'), price: 10.98, name: 'Produto 3' },
